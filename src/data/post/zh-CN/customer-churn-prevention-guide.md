...
category: 客户成功
  ...
  - 客户健康度
metadata:
  canonical: https://aitroop.net/zh-CN/blog/customer-churn-prevention-guide
---
...
*Aitroop 的客户健康度评分和流失预警功能，帮助 CSM 团队在流失发生前 30 天识别高风险客户，并自动触发个性化的挽留序列。[了解更多](https://app.aitroop.net)。*
